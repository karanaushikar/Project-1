    ...
    content: (
      <>
        <h4>
          !! श्री गणेशाय नमः !! <br />
          !! ॐ नमः शिवाय !! <br />
          || श्री सिदाजी आप्पा प्रसन्न || <br />
          !! शिव शरणार्थ !!
        </h4>

        <p>
          नगर शहर व परिसरात बऱ्याच देवस्थानच्या ठिक ठिकाणी गटागटाने एकत्र येऊन
          देणगीतून साप्ताहिक किंवा मासिक तिथी ला भंडारे होत असतात त्याच धर्तीवर
          आपणही श्री ब्रम्ह सिदाजीआप्पा भाविक भक्त गटागटाने एकत्र येवून
          'श्री क्षेत्र सावरगाव'येथे श्री ब्रम्ह सिदाजी आप्पांच्या मंदिरात प्रत्येक
          महिन्याच्या अमावास्येला श्री ब्रम्ह सिदाजी आप्पांचीआरती करून दुपारी 12
          ते 03 या वेळेत (भंडारा ) महा प्रसादाचे आयोजन सुरू केले आहे. तरी येणाऱ्या
          अमावस्येला ज्या ज्या भाविक भक्तांना महाप्रसाद (भंडारा) आयोजन करावयाची
          इच्छा असेल त्यांनी खालील नंबर वर संपर्क साधावा.
        </p>

        <p>
          श्री.विनोद बहिरवाडे...9423465399 <br />
          श्री.बाळासाहेब तोरडे...9860701015 <br />
          श्री. भीमा नागापुरे...7796183563
        </p>
      </>
    ),
    contributors: [
      "श्री.विनोद बहिरवाडे",
      "श्री.बाळासाहेब तोरडे",
      "श्री. भीमा नागापुरे"
    ],
    additionalImages: []
  }
...
const EventsPage = () => {
  ...
  const filteredNews = newsData.filter((news) => {
    ...
    if (!isNaN(newsDate.getTime())) {
      month = String(newsDate.getMonth() + 1).padStart(2, "0");
      year = String(newsDate.getFullYear());
    }
      ...
      >
        ...
        <div className="contributor-badge-list">
          {contributors.map((name, index) => (
            <span key={index} className="mini-badge">
              {name}
            </span>
          ))}
        </div>
  ...
  return (
    <div className="news-page">
      ...
      <section
        className="news-hero"
        style={{ backgroundImage: `url(${TempleImg2})` }}
      >
      ...
      <section className="filter-section">
        ...
        <div className="category-filters">
          {["सर्व", "उत्सव", "बैठक", "घोषणा", "कार्यक्रम"].map(
            (category) => (
              <button
                key={category}
                className={
